...
/**
 * DTO for updating an item in the inventory.
 * @description This class defines the properties that can be updated for an item, including name, description, and quantity.
 */
